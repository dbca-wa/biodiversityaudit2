define([
...
], function ($, _, Backbone, tables, filters, TableView, summaryTemplate, detailsTemplate, threatsCellTemplate, FaunaView) {
    ...
    /*
        ...
        Unfortunately inheritance from Backbone View is not trivial (as below).
        @todo: find a a way to properly inherits from a parent View.
     */
    var child = FaunaView.extend({
        el: '#taxonTab',
